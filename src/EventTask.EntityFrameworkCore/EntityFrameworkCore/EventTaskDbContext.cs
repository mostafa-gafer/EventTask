...
public class EventTaskDbContext :
    AbpDbContext<EventTaskDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public EventTaskDbContext(DbContextOptions<EventTaskDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(EventTaskConsts.DbTablePrefix + "YourEntities", EventTaskConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
